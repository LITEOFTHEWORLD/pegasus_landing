      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Access the best prices across multiple DEXs with our optimized
            routing engine. Stake $PGS and earn while you trade.
          </p>
        ...
        <div className="flex-1">
          <img src="/public/Ico-image1.jpeg" alt="hello" />
        </div>
      </div>
    </div>
  </div>
